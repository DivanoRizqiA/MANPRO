...
export default class ForgotPasswordPage {
  async render() {
    return `
      <div style="min-height:calc(100vh - 80px);display:flex;align-items:center;justify-content:center;padding:16px">
        <div style="width:100%;max-width:480px;margin:0 auto;transform:translateX(-16px);padding:24px;border:1px solid #e5e7eb;border-radius:8px;background:#fff;box-shadow:0 10px 24px rgba(0,0,0,0.08)">
