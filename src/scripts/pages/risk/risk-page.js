  ...
  async render() {
    ...
    <div class="hero-background">
      <div class="hero-container" id="risk-top">
        ...
        <!-- Health Recommendations (LLM-ready) -->
        <section id="health-recommendations" class="health-reco-section" aria-live="polite" style="margin-top:16px;">
          <div class="health-info-section">
            <h3 class="section-title">Rekomendasi Kesehatan</h3>
            <p class="section-description">Berikut rekomendasi personal yang dapat membantu menjaga kesehatan Anda. Bagian ini akan diisi otomatis setelah pengecekan atau saat fitur LLM aktif.</p>
          </div>
        ...
        <div class="result-container" style="display:none;">
          ...
          <div class="result-content">
            ...
            <div class="important-notice"><div class="notice-inner"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="notice-icon-blue"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg><div class="notice-text"><p><strong>Penting:</strong> Ini adalah penilaian risiko perkiraan berdasarkan data yang Anda masukkan. Silakan konsultasikan dengan profesional kesehatan untuk nasihat medis dan diagnosis yang tepat. Masuk untuk menyimpan hasil ini ke riwayat Anda.</p></div></div></div>
